...
<head>
    ...
    <link rel="stylesheet" type="text/css" id="theme" href="<?= $this->url->get('dash/css/theme-default.css') ?>"/>
    <link rel="stylesheet" href="<?= $this->url->get('front/assets/css/bootstrap.min.css') ?>">
...
<body>
<?= $this->getContent() ?>
    <script src="<?= $this->url->get('dash/js/plugins/jquery/jquery.min.js') ?>"></script>
    <script src="<?= $this->url->get('front/assets/js/formValidation.min.js') ?>"></script>
    <script type="text/javascript" src="<?= $this->url->get('front/assets/js/bootstrapV.min.js') ?>"></script>
    <script src="<?= $this->url->get('dash/js/custom.js') ?>"></script>
</body>
</html>