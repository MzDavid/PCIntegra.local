        ...
        <div class="page-sidebar mCustomScrollbar _mCS_1 mCS-autoHide page-sidebar-fixed scroll">
            <ul class="x-navigation">
                ...
                <li class="xn-openable <?php echo $this->router->getControllerName()=='notes'?"active":""?>">
                    ...
                    <ul>
                        <li class="<?php echo $this->router->getActionName()=='newnote'?"active":""?>"><a href="<?= $this->url->get('dashboard/notes/new-note') ?>"><span class="fa fa-pencil"></span> Nuevo caso de éxito</a></li>
                        <li class="<?php echo $this->router->getActionName()=='index'?"active":""?>"><a href="<?= $this->url->get('dashboard/notes') ?>"><span class="fa fa-file"></span> Todas los casos de éxito</a></li>
                ...
                <li class="xn-openable <?php echo $this->router->getControllerName()=='careers'?"active":""?>">
                    ...
                    <ul>
                        <li class="<?php echo $this->router->getActionName()=='new'?"active":""?>"><a href="<?= $this->url->get('dashboard/careers/new') ?>"><span class="fa fa-file"></span> Nuevo servicio</a></li>
                        <li class="<?php echo $this->router->getActionName()=='index'?"active":""?>"><a href="<?= $this->url->get('dashboard/careers/index') ?>"><span class="fa fa-file"></span> Todos los servicios</a></li>
                    </ul>
                </li>
