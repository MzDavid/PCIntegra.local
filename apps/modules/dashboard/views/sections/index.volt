                            ...
                            <table class="table SliderNewForm" id="section-positions">
                                ...
                                {% if(!slider is empty) %}
                                    <?php $count=0; foreach($slider as $key => $values):?>
                                        <tr class="tr-order" id="<?php echo $key+1;?>" data-post="{{values.getPid()}}">
                                            <td class="td-order">
                                                <label class="col-md-2 col-xs-12 control-label">Notas </label>
                                                <div class="col-md-8 col-xs-9">
                                                    <select name="SliderNew[]" id="ajax-post-slider-<?php echo $key+1?>" class="form-control" data-order="{{values.getOrderSlider()}}" data-last="{{values.getPid()}}" data-cgid="{{values.getCgid()}}"/>
                                                        <option value="{{values.getPid()}}" selected>{{values.getTitle()}}</option>
                                                    </select>
                                                </div>
                                    ...
                                    <?php for($i=$count+1;$i<=4;$i++):?>
                                        <tr class="tr-order" id="<?php echo $i?>" data-post="0">
                                            <td class="td-order">
                                                <label class="col-md-2 col-xs-12 control-label">Notas </label>
                                                <div class="col-md-8 col-xs-9">
                                                    <select name="SliderNew[]" id="ajax-post-slider-<?php echo $i;?>" class="form-control" data-order="<?php echo $i;?>" data-last="" data-cgid="{{cgt.getCgid()}}"/>
                                                    </select>
                                                </div>
                                                <i class="fa fa-arrows" style="margin-left: 7.5%;"></i>
                                            </td>
                                ...
                                <input type="hidden" value="{{cgt.getCgid()}}" id="cgid"/>
                            </table>
                        </div>
                    </div>
