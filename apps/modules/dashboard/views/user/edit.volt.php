            ...
            <div class="panel panel-default">
                <div class="panel-body profile" style="background: url('<?php echo $this->url->get('dash/assets/images/gallery/music-4.jpg'); ?>') center center no-repeat;">
                    ...
                    <div class="profile-data">
                        ...
                        <div class="profile-data-title" style="color: #000;"><?php echo $user->getCargo(); ?></div>
                    </div>
                        ...
                        <div class="col-md-12 col-xs-12 panel-body form-group-separated">
                            <form action="#" method="post" id="updateProfile" role="form" class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-xs-12">
                                        <input type="text" class="form-control" placeholder="Cargo" name="cargo" value="<?php echo $user->getCargo(); ?>" required/>
                                    </div>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="col-md-12 col-xs-12 panel-body form-group-separated">
                            <form action="#" method="post" id="updateSocialMedia" role="form" class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-xs-12">
                                        <input type="text" class="form-control" placeholder="Facebook" name="facebook" value="<?php echo $user->getFacebook(); ?>" required/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 col-xs-12 control-label">Twitter</label>
                                    <div class="col-md-6 col-xs-12">
                                        <input type="text" class="form-control" placeholder="Twitter" name="twitter" value="<?php echo $user->getTwitter(); ?>" required/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 col-xs-12 control-label">Google+</label>
                                    <div class="col-md-6 col-xs-12">
                                        <input type="text" class="form-control" placeholder="Google+" name="google" value="<?php echo $user->getGooglePlus(); ?>"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 col-xs-12 control-label">Instagram</label>
                                    <div class="col-md-6 col-xs-12">
                                        <input type="text" class="form-control" placeholder="Instagram" name="instagram" value="<?php echo $user->getInstagram(); ?>" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 col-xs-12 control-label">Pinterest</label>
                                    <div class="col-md-6 col-xs-12">
                                        <input type="text" class="form-control" placeholder="Pinterest" name="pinterest" value="<?php echo $user->getPinterest(); ?>" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 col-xs-12 control-label">Youtube</label>
                                    <div class="col-md-6 col-xs-12">
                                        <input type="text" class="form-control" placeholder="Youtube" name="youtube" value="<?php echo $user->getYoutube(); ?>" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-2">
