                    ...
                    <div class="table-responsive">
                        <table id="tableCategory" class="table table-bordered table-striped table-actions">
                            ...
                            <tr id="<?= $values->getCgid() ?>">
                                ...
                                <td><a href="<?= $this->url->get('dashboard/category/subcategory?id=' . $values->getCgid() . '&ctg=' . $values->getNameCategory()) ?>" class="btn btn-default btn-rounded btn-sm">&nbsp;<span class="fa fa-eye" style="font-size: 16px;color: #000;"></a></td>
                            </tr>
                            <?php } ?>
                            </tbody>
                        </table>
