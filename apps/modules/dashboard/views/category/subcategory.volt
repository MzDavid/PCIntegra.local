...
<div class="page-title">
    <div class="col-xs-12 col-sm-12 col-md-6">
        <h2><a href="{{url('dashboard/category')}}"><span class="fa fa-arrow-circle-o-left"></span></a> Menú principal</h2>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-6">
            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <table id="tableSubCategory" class="table table-bordered table-striped table-actions">
                            <thead>
                            <tr>
                                <th>Nombre</th>
                                <th>Opciones</th>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="defModalHead">Nueva Subcategoría</h4>
            </div>
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control cPL" placeholder="Nombre subcategoría" name="subcategoryname" required/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control cPL" placeholder="Repetir subcategoría" name="confirmCategory" required/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
...
<!--MODALS-->
<div class="modal" id="edit_subcategory" tabindex="-1" role="dialog" aria-labelledby="defModalHead" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">Cerrar</span></button>
            ...
            <form id="editSubCategory" action="#" method="post" rol="form" class="form-horizontal">
                <div class="modal-body">
                    <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                            <div class="input-group">
                                <span class="input-group-addon"><span class="fa fa-play-circle"></span></span>
                                <input id="nameCtg" type="text" class="form-control cPL" placeholder="Nombre Subcategoría" name="subcategoryname" required/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
