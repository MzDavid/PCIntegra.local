...
<ul class="breadcrumb">
    ...
    <li><a href="<?php echo $this->url->get('dashboard/photo'); ?>">Foto Notas</a></li>
    <li class="active"><a href="#">Editar Foto Nota</a></li>
</ul>
<!-- PAGE TITLE -->
<div class="page-title">
    <h2><a href="<?php echo $this->url->get('dashboard/photo'); ?>"><span class="fa fa-arrow-circle-o-left"></span></a> Salir</h2>
</div>
<!-- END BREADCRUMB -->
                ...
                <form action="#" method="post" id="newPhotoNote" name="newNote"role="form" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-xs-12">
                            <input id="photo-note-title" type="text" class="form-control" placeholder="Titulo" name="title" value="<?php echo $pn->getTitle(); ?>" required/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-xs-12">
                            <input id="note-permalink" type="text" class="form-control" value="<?php echo $pn->getPermalink(); ?>" placeholder="Enlace o Permalink" name="permalink" required readonly style="color: #000;"/>
                        </div>
                    </div>
                    <div class="form-group">
                            ...
                            <div id="ip-edit-principal-dz" class="dropzone dz-default dz-message">
                                <div class="dz-default dz-message">
                                    <h2 class="text-center">
                                        ...
                                        <input type="hidden" value="<?php echo $pn->getImage(); ?>" name="image" id="img-photo-principal-dz" >
                                    </h2>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-xs-12">
                            <div class="block">
                                <textarea class="summernote" name="summernote" cols="30" rows="10"><?php echo $pn->getContent(); ?></textarea>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-md-offset-2">
                            ...
                            <input type="hidden" name="pnid" id="pnid" value="<?php echo $pn->getPnid(); ?>"/>
                        </div>
                    </div>
                </form>
                <div class="form-group  fade in" id="EditGalleryPhotoNote">
                    ...
                    <div class="col-md-8 col-xs-12">
                        ...
                        <div id="gallery-photo-principal-dz" class="dropzone dz-default dz-message">
                            ...
                            <?php foreach ($gpn as $values) { ?>
                                <input type="hidden" name="photo_note[]" id="gry-photo-principal-dz" value="<?php echo $values->getName() . '|' . $values->getImgid(); ?>">
                            <?php } ?>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            ...
                            <table class="table" id="ddt-gallery-positions">
                                <tbody>
                                <?php foreach ($gpn as $values) { ?>
                                    <tr  data-id="<?php echo $values->getImgid(); ?>" data-name="<?php echo $values->getName(); ?>" class="images_gallery <?php echo $values->getImgid(); ?>"  id="<?php echo $values->getName() . '|' . $values->getImgid(); ?>" >
                                        <td>
                                            <img src="<?php echo $this->url->get('front/images/photo_notes/220x140/' . $values->getName()); ?>" alt="" />
                                        </td>
                                        <td class="title_image"><?php echo $values->getName(); ?></td>
                                        <td>
                                            <textarea name="sumary" class="form-control summary description_images" placeholder="Agregar una descripción" readonly autofocus><?php echo $values->getDescription(); ?></textarea><br>
