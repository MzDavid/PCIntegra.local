                    ...
                    <div class="row AdjustRow">
                        <div class="footer--widget col-md-4 col-sm-6">
                            ...
                            <div class="about--widget">
                                <ul class="directorio">
                                    <li><i class="fa fa-map-marker marcador" aria-hidden="true"></i>
                                        <p> Calle 48 num 6B entre 31A y 31B Col. Aviación. <br>Cd. Del Carmen Campeche, México</p>
                                    </li>
                                    <li><i class="fa fa-phone" aria-hidden="true"></i>
                                        <p> Tel. 938 38 14581</p>
                                    </li>
                                    <li><i class="fa fa-mobile-phone" aria-hidden="true"></i>
                                        <p> Cel. 938 133 6343</p>
                                    </li>
                                    <li><i class="fa fa-envelope-o" aria-hidden="true"></i>
                                        <p> Email: <a href="mailto:whau@pcintegra.mx" class="mail">whau@pcintegra.mx</a></p>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="footer--widget col-md-4 col-sm-12">
                            <div class="footer--title">
                                <div class="text">
                                    <h2 class="h4">Nuestros metodos de pago</h2>
                                </div>
                            </div>
