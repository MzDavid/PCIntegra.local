                ...
                <div class="tab-content">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <ul>
                                    ...
                                    <li><i class="fa fa-check-square-o"></i>Instalamos sistema de monitoreo por usuario para supervisión de sus empleados</li>
                                </ul>
                            </div>
                    ...
                    <div id="servicesTabItem03" class="tab-pane fade">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <p>Sistemas de control de llamadas, basados en tarificadores en tiempo real para ver el reporte de llamadas de su personal todos los días.</p>
                            </div>
                    ...
                    <div id="servicesTabItem04" class="tab-pane fade in active">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <ul>
                                    <li><i class="fa fa-check-square-o"></i>Arrendamiento de equipo de cómputo INTEGRANDO servicios de soporte técnico.</li>
                                    <li><i class="fa fa-check-square-o"></i>Contamos con la infraestructura y personal calificado para la prestación de este servicio.</li>
                                </ul>
                            </div>
