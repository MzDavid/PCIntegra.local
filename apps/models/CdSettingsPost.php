...
class CdSettingsPost extends \Phalcon\Mvc\Model
{
    ...
    /**
     * Method to set the value of field order_post
     *
     * @param integer $order_post
     * @return $this
     */
    public function setOrderPost($order_post)
    {
    ...
    /**
     * Returns the value of field order_post
     *
     * @return integer
     */
