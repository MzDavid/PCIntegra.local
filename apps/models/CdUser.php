...
class CdUser extends \Phalcon\Mvc\Model
{
    ...
    {
        $this->hasMany('uid', 'CdCareers', 'uid', ['alias' => 'CdCareers']);
        $this->hasMany('uid', 'CdClients', 'uid', ['alias' => 'CdClients']);
        $this->hasMany('uid', 'CdFollowUp', 'uid', ['alias' => 'CdFollowUp']);
        $this->hasMany('uid', 'CdMagazine', 'uid', ['alias' => 'CdMagazine']);
        $this->hasMany('uid', 'CdPost', 'uid', ['alias' => 'CdPost']);
        $this->hasMany('uid', 'CdSchool', 'uid', ['alias' => 'CdSchool']);
