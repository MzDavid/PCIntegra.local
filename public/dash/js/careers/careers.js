$(document).ready(function(){
    ...
    if($("#newCareer").length>=1){
        function validateEditor() {
            // Revalidate the content when its value is changed by Summernote
            $('#summernoteForm').formValidation('revalidateField', 'content');
        }
        $('#newCareer').formValidation({
            framework: 'bootstrap',
            icon: {
                valid: 'glyphicon glyphicon-ok',
                invalid: 'glyphicon glyphicon-remove',
                ...
                $.ajax({
                    ...
                    success : function(response){
                        if(response.code=="200"){
                            alertMessage("success","Archivo eliminada correctamente");
                        }else{
                            alertMessage("warning","El archivo no se ha eliminado de la base de datos");
                        }
