$(function() {
    ...
    var uiElements = function(){
        ...
        var uiDatatable = function(){
            if($(".datatable").length > 0){
            ...
            }if($(".photoNoteTable").length > 0){
                $(".photoNoteTable").dataTable({
                    iDisplayLength: 25,
                    order: [[ 2, "asc" ]],
                    "language": {
                        "lengthMenu": "Mostrar _MENU_ registros por página",
                ...
                $(".photoNoteTable").on('page.dt',function () {
                    onresize(100);
                });
            }
            if($(".generalDT").length > 0){
                var order = $(".generalDT").attr("data-order");
                var filter = $(".generalDT").attr("data-filter");
                $(".generalDT").dataTable({
                    iDisplayLength: 25,
                    order: [[ order, filter ]],
                    "language": {
        ...
        var uiSummernote = function(){
            ...
            /* Extended summercareers editor */
            if($(".summercareers").length > 0){
                $(".summercareers").summernote({height: 250,
                    codemirror: {
                        mode: 'text/html',
                        htmlMode: true,
                        lineNumbers: true,
            ...
            /* END Extended summercareers editor */

            /* Extended summercareers2 editor */
            if($(".summercareers2").length > 0){
                $(".summercareers2").summernote({height: 250,
                    codemirror: {
                        mode: 'text/html',
                        htmlMode: true,
                        lineNumbers: true,
            ...
            /* END Extended summercareers2 editor */

            /* Extended summercareers3 editor */
            if($(".summercareers3").length > 0){
                $(".summercareers3").summernote({height: 250,
                    codemirror: {
                        mode: 'text/html',
                        htmlMode: true,
                        lineNumbers: true,
            ...
            /* END Extended summercareers3 editor */
